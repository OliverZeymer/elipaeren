...
export default function Room({ text, selected, id, room, onPress, allRoomsOn }) {
  ...
  return (
    <div onClick={handleClick}>
      <ComponentWrapper
        ...
        className={
          isOn
            ? "bg-dark text-grey rounded-3xl p-6 flex items-center min-w-fit border-[3px] border-solid border-yellow"
            : "bg-dark text-grey rounded-3xl p-6 flex items-center min-w-fit border-[3px] border-solid border-transparent"
        }>
