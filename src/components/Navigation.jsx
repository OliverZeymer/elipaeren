...
export default function Navigation() {
  ...
  return (
    <ComponentWrapper
      type="nav"
      className="z-50 flex-row rounded-full sm:rounded-3xl justify-center fixed sm:top-4 w-full p-2 items-center bottom-0 sm:sticky flex select-none sm:bg-lighter sm:p-6 sm:flex-col sm:h-[96.5vh]"
    >
      <Logo className="mx-auto mb-12 hidden sm:flex" />
      <ul className="flex gap-8  justify-center rounded-3xl sm:justify-start w-full mx-auto bg-lighter sm:gap-6 sm:flex-col sm:h-full py-1 sm:py-0 shadow-sm shadow-primary sm:shadow-none">
