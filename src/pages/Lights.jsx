    ...
    <ComponentWrapper type="section" className="w-full flex flex-col justify-center gap-6">
      {!loading ? (
        <>
            ...
            <Tag
              ...
              onClick={() => {
                normalFetch({
                  method: "PUT",
                  url: putUrl,
                  body: JSON.stringify({ bri: 254, sat: 255, effect: "colorloop", alert: "none" }),
                })
              }}
            />
            ...
            <Tag
              ...
              onClick={() => {
                normalFetch({
                  method: "PUT",
                  url: putUrl,
                  body: JSON.stringify({ effect: "none", alert: "none", colormode: "hs", hue: 32767, bri: 254, sat: 0 }),
                })
              }}
            />
          ...
          <AllLights selectedLight={selectedLight} handleSelect={handleSelect} results={results} loading={loading} allLightsOn={allLightsOn} />
          <AnimatePresence>
            {selectedLight && (
              <motion.div
                ref={ref}
